...
func init() {
	proto.RegisterType((*RouteRequest)(nil), "router.RouteRequest")
	proto.RegisterType((*RouteResponse)(nil), "router.RouteResponse")
	proto.RegisterType((*GPSPoint)(nil), "router.GPSPoint")
}
...
var fileDescriptor_367072455c71aedc = []byte{
	...
	,
}
...
func (c *routerClient) Recommend(ctx context.Context, in *RouteRequest, opts ...grpc.CallOption) (*RouteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/router.Router/Recommend", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Router_Recommend_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/router.Router/Recommend",
	}
